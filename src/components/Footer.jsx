      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="transform transition duration-300 hover:translate-y--2">
            <div className="flex items-center gap-2 mb-4">
                <img src="/BaitAlLogo.png" className="h-25"></img>
            </div>
          ...
          <div className="transform transition duration-300 hover:translate-y--2">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#aboutus" className="hover:text-[#125476] transition duration-300 relative group">About Us<span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#125476] group-hover:w-full transition-all duration-300"></span></a></li>
              <li><a href="#services" className="hover:text-[#125476] transition duration-300 relative group">Services<span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#125476] group-hover:w-full transition-all duration-300"></span></a></li>
              <li><a href="#contactus" className="hover:text-[#125476] transition duration-300 relative group">Contact<span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#125476] group-hover:w-full transition-all duration-300"></span></a></li>
            </ul>
          </div>
          ...
          <div className="transform transition duration-300 hover:translate-y--2">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3 transition duration-300 hover:text-[#125476]">
                ...
                <span>Office 204, Mohammed Saleh Tower, Al Maktoum St., Deira, Dubai, UAE</span>
              </div>
              <div className="flex items-center gap-3 transition duration-300 hover:text-[#125476]">
                <Phone size={20} className="text-[#1D80B2] flex-shrink-0 transition duration-300 group-hover:text-[#125476]" />
                <a href="tel:+971502891582" className="hover:text-[#125476] transition duration-300">
                  +971 50 289 1582, +971 50 681 6994
                </a>
              </div>
              <div className="flex items-center gap-3 transition duration-300 hover:text-[#125476]">
                <Mail size={20} className="text-[#1D80B2] flex-shrink-0 transition duration-300 group-hover:text-[#125476]" />
                <a href="mailto:info@baithome.co" className="hover:text-[#125476] transition duration-300">
                  info@baithome.co
                </a>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          {/* <div className="flex gap-6">
            ...
            <a href="#insinftagram" className="hover:text-[#125476] transition duration-300 transform hover:scale-110 active:scale-95">
              <Instagram size={24} />
            </a>
